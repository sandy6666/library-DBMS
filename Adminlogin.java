...
public class Adminlogin extends JFrame implements ActionListener
{
	...
	public Adminlogin()
	{
		...
		lbl=new JLabel("ADMIN LOGIN");  	lbl.setFont(new Font("IMPACT",0,50));	lbl.setForeground(new Color(14,58,119));
	...
	{	
		...
		if(str1.equals("Login"))
		{
			...
			usr=tuname.getText();
			pass=tpsw.getText();
			if(usr.equalsIgnoreCase("Admin")&&pass.equalsIgnoreCase("Admin123"))
